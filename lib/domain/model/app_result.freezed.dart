...
abstract class $AppResultCopyWith<T, $Res> {
  factory $AppResultCopyWith(
      ...
      _$AppResultCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$AppResultCopyWithImpl<T, $Res> implements $AppResultCopyWith<T, $Res> {
  _$AppResultCopyWithImpl(this._value, this._then);

  final AppResult<T> _value;
  // ignore: unused_field
  final $Res Function(AppResult<T>) _then;
}
...
/// @nodoc
class __$$SuccessCopyWithImpl<T, $Res> extends _$AppResultCopyWithImpl<T, $Res>
...
abstract class Success<T> extends AppResult<T> {
  factory Success({required final T data}) = _$Success<T>;
  Success._() : super._();
...
/// @nodoc
class __$$FailureCopyWithImpl<T, $Res> extends _$AppResultCopyWithImpl<T, $Res>
...
class _$Failure<T> extends Failure<T> with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'AppResult<$T>.failure'))
...
abstract class Failure<T> extends AppResult<T> {
  factory Failure({required final AppError error}) = _$Failure<T>;
  Failure._() : super._();
